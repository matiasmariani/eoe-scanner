        ...
        >
          {ALLERGY_OPTIONS.map((option) => (
            <button
              ...
              className={cn(
                'flex flex-col items-center justify-center gap-2 p-8 border-4 transition-all active:translate-x-[2px] active:translate-y-[2px] focus:ring-4 focus:ring-theme-accent rounded-[2.5rem] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-[1px]',
