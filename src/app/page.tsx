        ...
        <AnimatePresence mode="wait">
          ...
          {mode === "scanning" && (
            ...
            >
              ...
              <button
                ...
                className="flex items-center gap-3 text-gray-600 font-black text-2xl mx-auto bg-white px-10 py-4 rounded-full shadow-lg hover:bg-gray-50 transition-all"
              >
          ...
          {mode === "loading" && (
            ...
            >
              ...
              <p className="text-4xl font-black text-blue-500 mt-10 animate-bounce">Checking...</p>
            </motion.div>
          )}
          ...
          {mode === "error" && (
            ...
            >
              <div className="bg-rose-50 p-10 rounded-[4rem] border-8 border-rose-500 text-center shadow-2xl">
                ...
                <h3 className="text-4xl font-black text-rose-600 uppercase tracking-tighter">Uh Oh!</h3>
